...
public struct ComplexTileFlags1 : IPackedSerializable
{
...
public struct ComplexTileFlags2 : IPackedSerializable
{
    public byte InnerData;
...
public struct ComplexTileFlags3 : IPackedSerializable
{
    public byte InnerData;
...
public struct ComplexTileFlags4 : IPackedSerializable
{
    public byte InnerData;
