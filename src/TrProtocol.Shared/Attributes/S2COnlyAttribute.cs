...
/// <summary>
/// Marks a member as only applicable for the server-to-client direction.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// <para>
/// This attribute is mutually exclusive with <see cref="C2SOnlyAttribute"/>; applying both produces a generator error
/// (e.g. <c>SCG03</c>).
/// </para>
/// </remarks>
