...
public enum MessageID : byte
{
    ...
    Unused83 = 83,
    [Obsolete("Unused")]
    NPCKillCountDeathTally = Unused83,
    PlayerStealth = 84,
    QuickStackChests = 85,
    ...
    SyncItemsWithShimmerDeprecated = 145,
    ShimmerActions = 146,
    SyncLoadout = 147,
    SyncItemCannotBeTakenByEnemiesDeprecated = 148,
    ...
    // Aliases matching TShock PacketTypes
    ...
    CreateCombatText = 81,
    LoadNetModule = 82,
    [Obsolete("Packet 83 is unused in Terraria 1.4.5.7.")]
    NpcKillCount = Unused83,
    ForceItemIntoNearestChest = 85,
    UpdateTileEntity = 86,
    PlaceTileEntity = 87,
    TweakItem = 88,
    PlaceItemFrame = 89,
    UpdateItemDrop = SpawnInstancedItem,
    EmoteBubble = 91,
    DebugCommands = 94,
    KillPortal = 95,
